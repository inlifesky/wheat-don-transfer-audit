...
Reproducibility repository for a manuscript under review. The analysis pipeline reproduces every number, table and figure in the manuscript, including the supplement. The underlying spectral data are openly deposited at Dryad and are **not** redistributed here; see [Data](#data) below for download instructions.
